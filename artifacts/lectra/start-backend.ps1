...
# Backend (port 8000)
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$PSScriptRoot\..\api-server\backend'; pip install -r requirements.txt -q; uvicorn main:app --host 0.0.0.0 --port 8000"
